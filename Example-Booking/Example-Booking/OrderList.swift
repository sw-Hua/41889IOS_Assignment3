                ...
                VStack{
                    ForEach(orderList, id: \.date){item in
                        ...
                        VStack{
                            ...
                            Text("selectedTable0: \(item.selectedTable0)").fontWeight(.bold).foregroundColor(.white).padding(.vertical)
                            Text("selectedTable1: \(item.selectedTable1)").fontWeight(.bold).foregroundColor(.white).padding(.vertical)
                            Text("price: \(item.price)").fontWeight(.bold).foregroundColor(.white).padding(.vertical).padding(.bottom, 50)
                            HStack{
