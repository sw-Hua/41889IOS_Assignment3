...
//    let filter = CIFilter.qrCodeGenerator()
    ...
    var body: some View {
        ...
        ScrollView(.vertical, showsIndicators: false, content: {
            ...
            HStack{
                Button(action: {
                    let thisOrer = OrderInfo(date: UserDefaults.standard.string(forKey: "Date") ?? "", time: UserDefaults.standard.string(forKey: "selectedTiming") ?? "", selectedTable0: UserDefaults.standard.string(forKey: "selectedTable0") ?? "", selectedTable1: UserDefaults.standard.string(forKey: "selectedTable1") ?? "", price: UserDefaults.standard.string(forKey: "totalPrice") ?? "")
